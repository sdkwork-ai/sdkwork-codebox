# Runbook — sdkwork-codebox deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-codebox-standalone:3.12.1`
...
install syncs the bundle to `/opt/deploy/sdkwork-codebox/bundle`, loads the image, starts
...
bin/docker-deploy.sh rollback --environment staging --to 3.12.1       # explicit version
```
