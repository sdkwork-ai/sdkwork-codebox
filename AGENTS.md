...
Read [`specs/codebox-local-conventions.md`](specs/codebox-local-conventions.md) only when a task reaches desktop-shell composition, package ownership, local build or test workflow, or contribution guidance. It narrows this repository's implementation workflow; `specs/component.spec.json`, `ARCHITECT.md`, and `../sdkwork-specs/` remain the applicable authorities.
